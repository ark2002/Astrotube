  ...
  return (
    <div className="playlist-video__container flex--row">
      <img
        ...
        alt="thubmnail"
        className="playlist-thumbnail__img"
      ...
      <div className="video__copy flex--column">
        ...
        <div className="video__copy-btns flex--row">
          ...
          <button
            className="btn btn-transparent--primary  btn-font--secondary"
            onClick={() => deleteFromPlaylistHandler(_id)}
          >
      ...
      <div className="playlist-video__action flex--column">
        <div className="video__creator flex--column">
          <img
            src={creatorImg}
            alt="creator"
            className="playlist--creator__img"
          />
