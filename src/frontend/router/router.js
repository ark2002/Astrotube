...
import { AddToPlaylistScreen, HistoryScreen, LandingScreen, LikedVideosScreen, ListingScreen, PageNotFoundScreen, PlaylistsScreen, SigninScreen, SignupScreen, SinglePlaylistScreen, VideoScreen, WatchLaterScreen } from "../screens";
...
const Router = () => {
    ...
    return (
        <Routes>
            ...
            <Route path="/addToPlaylist" element={<PrivateRoute><PlaylistRoute><AddToPlaylistScreen /></PlaylistRoute></PrivateRoute>} />
            ...
            <Route path="/playlist/:playlistId" element={<PrivateRoute><SinglePlaylistScreen /></PrivateRoute>} />
